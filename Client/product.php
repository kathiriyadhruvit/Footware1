	...
	<div class="container">
		<div class="item">
			...
			<img src="../img/Athleisurebanner.webp" style="width:100%;">
										...
										<!-- <div class="pro-1">
                        <img src="../img/Athleisure/mens_2.webp" alt="product_1" class="pimg">
                        <h4>Title</h4>
                        <p>Description</p>
                    ...
                    <!-- product _2 start -->
                    <!-- <div class="pro-2">
                            <img src="../img/Athleisure/mens_3.webp" alt="product_1"class="pimg">
                            <h4>Title</h4>
                            <p>Description</p>
                            <span>oldPrice</span><span>NewPrice</span><br>
                            <button class="btn" id="btn">Buy Now</button>
                    ...
                    <!-- product_3 start -->
                 <!--     <div class="pro-3">
                            <img src="../img/Athleisure/mens_4.webp" alt="product_2" class="pimg">
                            <h4>Title</h4>
                            <p>Description</p>
                            <span>oldPrice</span><span>NewPrice</span><br>
                            <button class="btn" id="btn">Buy Now</button>
